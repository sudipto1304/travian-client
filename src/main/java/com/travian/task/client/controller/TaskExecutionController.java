...
public class TaskExecutionController {
	...
	public ResponseEntity<String> execute(@RequestBody AccountInfoRequest request, HttpServletRequest servletRequest, @RequestHeader HttpHeaders headers) throws IOException, InterruptedException {
